...
public class CubeManipulate : MonoBehaviour
{
    ...
    private IEnumerator MoveSquareWay()
    {
        float delay = 1f;
        yield return MoveTo(new Vector3(sideSize, 0, 0), delay);
        yield return MoveTo(new Vector3(0, 0, sideSize), delay);
        yield return MoveTo(new Vector3(-sideSize, 0, 0), delay);
        yield return MoveTo(new Vector3(0, 0, -sideSize), delay);
        yield return null;
    }

    private IEnumerator MoveTriangleWay()
    {
        float delay = 1f;
        yield return MoveTo(new Vector3(-sideSize*2, 0, 0), delay);
        yield return MoveTo(new Vector3(sideSize, 0, sideSize), delay);
        yield return MoveTo(new Vector3(sideSize, 0, -sideSize), delay);
        yield return null;
    }
    ...
    private IEnumerator MoveOncurrentWay()
    {
        while (true)
        {
            ...
            yield return MoveSquareWay();
            yield return new WaitForSeconds(1f);
            yield return MoveTriangleWay();
            yield return new WaitForSeconds(1f);
        }
